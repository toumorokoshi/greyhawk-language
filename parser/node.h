...
typedef std::vector<NExpression8> ExpressionsList;
typedef std::vector<NVariableDeclaration8> VariableList;
...
class NMethodCall : public NExpression {
 public:
  ...
  NMethodCall(const NIdentifier& id, ExpressionsList& arguments) : 
