...
This probably won't work in it's current form:

* protected -> public method modification breaks interface (because of losing the underscore)
* renaming variables is a pain
